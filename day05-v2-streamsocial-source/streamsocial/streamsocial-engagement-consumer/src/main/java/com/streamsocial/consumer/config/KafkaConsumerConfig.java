...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, ContentInteractionEvent> engagementConsumerFactory() {
        ...
        // The Day 4 producer's traffic shape (type headers disabled) means
        // this deserializer is told the target type directly instead of
        // trusting a header - content-interactions has no real producer
        // yet, so this module ships its own test-data generator, but the
        // wire format is designed to match what a real one would emit.
