...
/**
 * Named {@code *IT} - runs under Failsafe, needs Docker. Real Spring
 * context, real broker, a real producer publishing onto the topic, and
 * the actual {@link EngagementEventListener} bean doing the consuming -
 * no mocked {@code KafkaConsumer} anywhere.
 */
@Testcontainers
@SpringBootTest
class EngagementEventListenerIT {
    ...
    private boolean waitUntil(long timeoutMillis, BooleanSupplier condition) throws InterruptedException {
