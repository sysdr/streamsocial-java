...
/**
 * Named {@code *IT} deliberately - runs under Failsafe during
 * {@code mvn verify}, not under plain {@code mvn test} (Appendix C).
 * Real Spring context, real broker in a container, a real HTTP call,
 * and a real independent consumer reading the message back off the
 * topic - no mocked {@code KafkaTemplate} anywhere in this test.
 */
@Testcontainers
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
class UserActionControllerIT {
