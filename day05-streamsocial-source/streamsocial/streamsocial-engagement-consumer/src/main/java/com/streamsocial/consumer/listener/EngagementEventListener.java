...
public class EngagementEventListener {
    ...
    /**
     * A deliberate failure hook for Day 5's error-handling demo only - not
     * a pattern for real listener logic. Standing in for "some downstream
     * dependency this listener needs is temporarily unavailable."
     */
    ...
    public EngagementEventListener(Validator validator) {
