...
class DomainEventValidationTest {
    ...
    void domainEventSealedHierarchyExhaustiveSwitchCompiles() {
        ...
        // instanceof patterns (Java 16+) keep this Java-17-safe; switch patterns need 21+.
        String category;
        if (event instanceof UserActionEvent) {
            ...
            throw new AssertionError("sealed DomainEvent hierarchy missing a branch: " + event.getClass());
        }
